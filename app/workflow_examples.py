...
class WorkflowExamples:
    ...
    def create_ecommerce_workflow() -> CrawlerConfiguration:
        ...
        selections = [
            ElementSelection(
                "products", ".product-card", "items_container", "Product cards"
            ),
            ElementSelection("title", ".product-title", "data_field", "Product title"),
            ElementSelection("price", ".price", "data_field", "Product price"),
            ElementSelection(
                "image", ".product-image img", "data_field", "Product image", "src"
            ),
            ElementSelection("rating", ".rating", "data_field", "Product rating"),
            ElementSelection(
                "description", ".product-description", "data_field", "Full description"
            ),
            ElementSelection(
                "specifications", ".specs-table", "data_field", "Product specs"
            ),
            ElementSelection(
                "reviews", ".review-item", "data_field", "Customer reviews"
            ),
            ElementSelection(
                "seller_info", ".seller-name", "data_field", "Seller information"
            ),
        ]
    ...
    def create_job_board_workflow() -> CrawlerConfiguration:
        ...
        selections = [
            ...
            ElementSelection(
                "requirements", ".requirements", "data_field", "Job requirements"
            ),
            ElementSelection(
                "company_info", ".company-overview", "data_field", "Company information"
            ),
            ElementSelection(
                "benefits", ".benefits-list", "data_field", "Job benefits"
            ),
        ]
    ...
    def create_news_site_workflow() -> CrawlerConfiguration:
        ...
        selections = [
            ElementSelection(
                "articles", ".article-card", "items_container", "News articles"
            ),
            ...
            ElementSelection(
                "publish_date", ".publish-date", "data_field", "Publication date"
            ),
            ElementSelection(
                "full_content", ".article-body", "data_field", "Full article content"
            ),
            ElementSelection(
                "author_bio", ".author-bio", "data_field", "Author biography"
            ),
            ElementSelection(
                "tags", ".article-tags .tag", "data_field", "Article tags"
            ),
            ElementSelection(
                "comments_count", ".comments-count", "data_field", "Number of comments"
            ),
        ]
    ...
    def create_social_media_workflow() -> CrawlerConfiguration:
        ...
        selections = [
            ElementSelection(
                "posts", ".post-item", "items_container", "Social media posts"
            ),
            ElementSelection("username", ".username", "data_field", "User name"),
            ElementSelection(
                "post_text", ".post-content", "data_field", "Post content"
            ),
            ...
            ElementSelection(
                "shares", ".share-count", "data_field", "Number of shares"
            ),
            ElementSelection(
                "user_profile", ".user-bio", "data_field", "User profile info"
            ),
            ElementSelection(
                "comments", ".comment-text", "data_field", "Post comments"
            ),
        ]
...
async def demo_workflow_examples():
    ...
    use_example = input(
        "\n🧪 Test an example workflow? Enter name or 'n' to skip: "
    ).strip()
